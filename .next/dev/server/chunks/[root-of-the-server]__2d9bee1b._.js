...
async function handler(req, res) {
    try {
        ...
        const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$api$2f$_plaid$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["plaid"].itemPublicTokenExchange({
            public_token
        });
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["setAccessToken"])(resp.data.access_token);
        res.status(200).json({
            ok: true
        });
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d9bee1b._.js.map